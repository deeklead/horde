// Package relics provides dog agent bead management.
package relics
...
func (b *Relics) CreateDogAgentBead(name, location string) (*Issue, error) {
...
// Searches for agent relics with role_type:dog and matching title.
// Returns nil if not found.
func (b *Relics) FindDogAgentBead(name string) (*Issue, error) {
	// List all agent relics and filter by role_type:dog label
...
func (b *Relics) DeleteDogAgentBead(name string) error {
