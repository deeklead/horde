// Package relics provides merge slot management for serialized conflict resolution.
package relics
...
// MergeSlotCreate creates the merge slot bead for the current warband.
// The slot is used for serialized conflict resolution in the merge queue.
// Returns the slot ID if successful.
func (b *Relics) MergeSlotCreate() (string, error) {
...
func (b *Relics) MergeSlotCheck() (*MergeSlotStatus, error) {
...
func (b *Relics) MergeSlotAcquire(holder string, addWaiter bool) (*MergeSlotStatus, error) {
...
func (b *Relics) MergeSlotRelease(holder string) error {
...
func (b *Relics) MergeSlotEnsureExists() (string, error) {
