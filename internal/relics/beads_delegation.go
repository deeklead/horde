// Package relics provides delegation tracking for work units.
package relics
...
//
// Note: This is stored as metadata on the child issue until rl CLI has native
// delegation support. Once rl supports `rl delegate add`, this will be updated.
func (b *Relics) AddDelegation(d *Delegation) error {
	if d.Parent == "" || d.Child == "" {
...
func (b *Relics) RemoveDelegation(parent, child string) error {
...
func (b *Relics) GetDelegation(child string) (*Delegation, error) {
...
func (b *Relics) ListDelegationsFrom(parent string) ([]*Delegation, error) {
