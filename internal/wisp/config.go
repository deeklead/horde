// Package wisp provides utilities for working with the .relics-wisp directory.
...
const WispConfigDir = ".relics-wisp"
...
// Storage location: .relics-wisp/config/<warband>.json
...
// Config provides access to wisp-based config storage for a specific warband.
...
// NewConfig creates a new Config for the given warband.
// townRoot is the path to the encampment directory (e.g., ~/horde).
// rigName is the warband identifier (e.g., "horde").
