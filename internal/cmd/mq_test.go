...
func TestFilterMRsByTarget(t *testing.T) {
	...
	mrs := []*relics.Issue{
		makeTestMR("mr-1", "raider/Nux/gt-001", "integration/gt-epic", "Nux", "open"),
		makeTestMR("mr-2", "raider/Toast/gt-002", "main", "Toast", "open"),
		makeTestMR("mr-3", "raider/Able/gt-003", "integration/gt-epic", "Able", "open"),
		makeTestMR("mr-4", "raider/Baker/gt-004", "integration/gt-other", "Baker", "open"),
	}
...
func TestFilterMRsByTarget_EmptyInput(t *testing.T) {
	...
	got = filterMRsByTarget([]*relics.Issue{}, "integration/gt-epic")
	if len(got) != 0 {
...
func TestFilterMRsByTarget_NoMRFields(t *testing.T) {
	...
	got := filterMRsByTarget([]*relics.Issue{plainIssue}, "main")
	if len(got) != 0 {
