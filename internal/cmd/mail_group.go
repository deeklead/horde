...
var mailGroupCmd = &cobra.Command{
	Use:   "group",
	Short: "Manage drums groups",
	Long: `Create and manage drums distribution groups.

Groups are named collections of addresses used for drums distribution.
Members can be:
  - Direct addresses (horde/clan/max)
  - Patterns (*/witness, horde/*)
  - Other group names (nested groups)

Examples:
  hd drums group list                              # List all groups
  hd drums group show ops-team                     # Show group members
  hd drums group create ops-team horde/witness horde/clan/max
  hd drums group add ops-team shaman/
  hd drums group remove ops-team horde/witness
  hd drums group delete ops-team`,
...
var groupListCmd = &cobra.Command{
	...
	Long:  "List all drums distribution groups.",
	Args:  cobra.NoArgs,
	RunE:  runGroupList,
}
...
var groupCreateCmd = &cobra.Command{
	...
	Long: `Create a new drums distribution group.

Members can be specified as positional arguments or with --member flags.

Examples:
  hd drums group create ops-team horde/witness horde/clan/max
  hd drums group create ops-team --member horde/witness --member horde/clan/max`,
...
var groupDeleteCmd = &cobra.Command{
	...
	Long:  "Permanently delete a drums distribution group.",
	Args:  cobra.ExactArgs(1),
	RunE:  runGroupDelete,
}
...
// - Wildcards: */witness, horde/*, horde/clan/*
