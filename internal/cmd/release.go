...
Examples:
  hd release gt-abc           # Release single issue
  hd release gt-abc gt-def    # Release multiple issues
  hd release gt-abc -r "worker died"  # Release with reason
...
func runRelease(cmd *cobra.Command, args []string) error {
	// Get working directory for relics
	cwd, err := os.Getwd()
	if err != nil {
