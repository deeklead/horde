...
const (
	// Autonomous roles (raider, witness, forge) need drums in SessionStart
	// because they may be triggered externally without user input.
	Autonomous RoleType = "autonomous"

	// Interactive roles (warchief, clan) wait for user input, so UserPromptSubmit
	// handles drums injection.
