...
func (m Model) renderView() string {
	...
	// Title
	b.WriteString(titleStyle.Render("Raids"))
	b.WriteString("\n\n")
	...
	// Empty state
	if len(m.raids) == 0 && m.err == nil {
		b.WriteString("No raids found.\n")
		b.WriteString("Create a raid with: hd raid create <name> [issues...]\n")
	}
	...
	for ci, c := range m.raids {
		...
		if isSelected {
			...
			b.WriteString(raidStyle.Render(line))
		}
		b.WriteString("\n")
		pos++
