...
// Example: gt-mr-abc123 for a horde merge request.
//
// Parameters:
//   - prefix: The project prefix (e.g., "hd" for horde)
//   - branch: The source branch name (e.g., "raider/Nux/gt-xyz")
//
...
//
// Parameters:
//   - prefix: The project prefix (e.g., "hd" for horde, "rl" for relics)
//   - branch: The source branch name (e.g., "raider/Nux/gt-xyz")
