...
// Forge represents a warband's merge queue processor.
type Forge struct {
	// RigName is the warband this forge processes.
	...
	// StartedAt is when the forge was started.
...
type MergeRequest struct {
	...
	// Branch is the source branch name (e.g., "raider/Toast/gt-abc").
	Branch string `json:"branch"`

	// Worker is the raider that created this branch.
	Worker string `json:"worker"`

	// IssueID is the relics issue being worked on.
...
// Uses relics-style statuses for consistency with the issue tracking system.
...
// FailureLabel returns the relics label for this failure type.
