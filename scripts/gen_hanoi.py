...
depends on the previous one. This tests Horde's ability to:
...
- Use `hd handoff` when context fills (proactive cycling)
...
This proves Horde can execute arbitrarily long workflows with
