...
Thanks for your interest in contributing! Horde is experimental software, and we welcome contributions that help explore these ideas.
...
4. Build and test: `go build -o hd ./cmd/hd && go test ./...`
